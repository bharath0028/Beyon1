                ...
                ie = function() {
                    ...
                    return a(e, [{
                        ...
                        value: function(e, t) {
                            ...
                            for (var c = new $.a, p = ["fonts/schnyder.json", "fonts/schnyder-outline.json", "fonts/suisse.json", "fonts/futura.json", "fonts/gemola.json"], m = function(e) {
                    ...
                    return d(t, e), c(t, [{
                        ...
                        value: function() {
                            ...
                            if (this.texture && this.texture.name) {
                                if (-1 !== this.texture.name.indexOf("all jewellery.jpg")) {
                                    scaleFactor = 0.5;
                                }
                                if (-1 !== this.texture.name.indexOf("y-main.png")) {
                                    scaleFactor = 0.9;
                                }
                                // make beyondiamond larger by default
                                if (-1 !== this.texture.name.indexOf("beyondiamond.png")) {
                                    scaleFactor = 1.9;
                                }
                                if (-1 !== this.texture.name.indexOf("beyondiamond2.png")) {
                                    scaleFactor = 3.1;
                                }
                                if (-1 !== this.texture.name.indexOf("beyondiamond1.png")) {
                                    scaleFactor = 2.4;
                                }
                                // downscale any bangels images (bangels1.webp..bangels5.webp or bangels.webp)
                            ...
                            this.align = t;
                            var zPos = -300 * this.itemIndex - 200;
                            if ("feb" === this.month && this.texture && this.texture.name) {
                                if (-1 !== this.texture.name.indexOf("bangels.webp") || -1 !== this.texture.name.indexOf("bangels1.webp") || -1 !== this.texture.name.indexOf("bangels2.webp") || -1 !== this.texture.name.indexOf("bangels3.webp") || -1 !== this.texture.name.indexOf("bangels4.webp") || -1 !== this.texture.name.indexOf("bangels5.webp") || -1 !== this.texture.name.indexOf("bangels")) {
                                    zPos = -1220;
                                    // nudge these slightly back and keep them visually behind
                                    o.x = o.x; 
                                }
                                if (-1 !== this.texture.name.indexOf("all jewellery.jpg")) {
                                    zPos = -1320;
                                ...
                                if (-1 !== this.texture.name.indexOf("slide3.1video.mp4")) {
                                    zPos = -1220;
                                }
                                if (-1 !== this.texture.name.indexOf("slide3video.mp4")) {
                                    zPos = -1820;
                                }
                                if (-1 !== this.texture.name.indexOf("y-main.png")) {
                                    o.x = 0;
                            ...
                            if ("jun" === this.month && this.texture && this.texture.name) {
                                if (-1 !== this.texture.name.indexOf("beyondiamond1.png")) {
                                    ...
                                    o.x = 350;  // right
                                    o.y = 250;  // top
                                    zPos = -1000; // align with heading plane
                                }
                                if (-1 !== this.texture.name.indexOf("beyondiamond.png")) {
                                    // place beyondiamond at the top-left of the JUN heading
                                    o.x = -350; // left
                                    o.y = 350;  // top
                                    zPos = -700; // place near the heading plane
                                }
                                if (-1 !== this.texture.name.indexOf("beyondiamond2.png")) {
                                    // place beyondiamond2 at the bottom-left of the JUN heading
                                    o.x = -550; // left
                                    o.y = -450; // bottom
                                    zPos = -700; // align with heading plane depth
                                }
                            }
                        ...
                        value: function() {
                            if (("" !== this.data.caption || "" !== this.data.link) && "" !== this.data.caption) {
                                var fontName = this.month === "jan" ? "Gemola" : "Schnyder L";
                                ...
                                if (this.data.caption.includes('\n')) {
                                    ...
                                    if (this.texture && this.texture.name.includes("y-main.png")) {
    // Position caption to the right side
    ...
    this.caption.position.set(0, -this.mesh.scale.y / 2 - 50, 0);
                ...
                de = function(e) {
                    ...
                    return C(t, e), v(t, [{
                        ...
                        value: function() {
                            if (this.section === "jan") {
                                var logoTexture = new Z.a().load("assets/intro/BEYONLOGO.png");
                                logoTexture.magFilter = logoTexture.minFilter = te.M;
                                var logoMat = new X.a({
                                        map: logoTexture,
                                        transparent: !0
                                    }),
                                    logoGeometry = new q.b(1, 1),
                                    logoMesh = new V.a(logoGeometry, logoMat);
                                logoMesh.scale.set(1200, 600, 1), logoMesh.position.set(0, 0, 0), this.add(logoMesh);
                                this.addBottomCTA();
                            } else {
                                var fontKey = "Schnyder L";
                                if ("feb" === this.section || "apr" === this.section || "may" === this.section || "jun" === this.section) fontKey = "Gemola";
                                ...
                                t.position.set(this.timeline.months[this.section].offset || 0, 0, -900), this.add(t);
                                ...
                                if ("jun" === this.section) {
                                    var para1 = new N.a("Lab diamonds are created by replicating the same heat and pressure found deep within the Earth.", {
                                        font: this.timeline.assets.fonts["Futura"],
                                        size: 28,
                                        height: 0,
                                        curveSegments: 6
                                    }).center();
                                    var paraMesh1 = new V.a(para1, this.timeline.contactTextMat);
                                    paraMesh1.position.set(this.timeline.months[this.section].offset || 0, -220, -900);
                                    this.add(paraMesh1);
                                    ...
                                    paraMesh2.position.set(this.timeline.months[this.section].offset || 0, -260, -900);
                                    this.add(paraMesh2);
                                }
                            }
                        }
                        ...
                        value: function() {
                            ...
                            // create loader and a placeholder mesh — size will be corrected once the texture loads
                            var _loader = new Z.a();
                            // create a temporary texture object returned synchronously (will be populated on load)
                            var placeholderTex = _loader.load("assets/intro/its_time_to_go.png", function(loadedTex) {
                                try {
                                    ...
                                    // compute intrinsic aspect ratio and apply exact scale
                                    ...
                                    var desiredW = 900;
                                    var desiredH = Math.round(desiredW * ih / iw || 125);
                            ...
                            // reasonable initial size until the real image loads
                ...
                fe = {
                    intro: ["BEYONLOGO.png", "its_time_to_go.png"],
                    // jan: ["slide3video.mp4", "manifesto6.png", "manifesto5.png", "dark.mp4", "manifesto4.png", "iceland-orig.mp4", "manifesto2.png", "nike.mp4", "manifesto3.png", "slide3.1video.mp4", "manifesto1.png"],
                    jan: [],
                    feb: [ "bangels.webp", "slide3.1video.mp4", "slide3video.mp4", "all jewellery.jpg","y-main.png"],
                    mar: ["When_To_Travel_Event_Loop_1080p.mp4.mp4"],
                    apr: [ "bangels1.webp", "bangels2.webp", "bangels3.webp", "bangels4.webp", "all jewellery.jpg", "more.png"],
                    may: [],
                    jun: ["its-official-video.mp4", "beyondiamond1.png", "beyondiamond2.png", "beyondiamond.png", "jack.mp4", "plasticdreams_fullsize.mp4"],
                ...
                ve = function() {
                    ...
                    return M(e, [{
                        ...
                        value: function() {
                            ...
                            }, this.c.globalScale = Math.min(1, this.c.size.w / 1400), this.c.touchEnabled ? document.documentElement.classList.add("touch-enabled") : document.documentElement.classList.add("enable-cursor"), this.assetList = fe, this.assetList.intro = ["ok.png", "beyon.png"], this.assetList.end = ["wave.mp4"], this.assetData = be, this.timelineEntered = !1, this.activeMonth = "intro", this.months = he, this.monthPositions = {}, this.remainingMonths = [], this.enableLoader = !0, this.gyroEnabled = !1, this.orientation = {
                                gamma: 0,
                                beta: 0
